...
//go:generate protoc --go_out=paths=source_relative:./pkg/domain/ --goconstrgen_out=paths=source_relative:./pkg/domain/ proto/gex/contracts/models.proto
// protoc is sometimes just awful
//go:generate rm -rf pkg/domain/contracts/models.con.go pkg/domain/contracts/models.pb.go
//go:generate cp pkg/domain/proto/gex/contracts/models.con.go pkg/domain/proto/gex/contracts/models.pb.go pkg/domain/contracts
//go:generate rm -r pkg/domain/proto/

//go:generate protoc --go-grpc_out=. --goblthttp_out=. proto/gex/contracts/service.proto
